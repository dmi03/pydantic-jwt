...
class JWTStr(str):
    ...
    def _validate(cls, value: Any) -> None:
        ...
        try:
            ...
            raise PydanticCustomError("jwt_format", "Header and payload must be valid JSON") from None
    ...
    def header(self) -> dict[str, Any]:
        ...
        return cast(
            "dict[str, Any]",
            json.loads(self._decode_segment(self.split(".")[0]).decode()),
        )
    ...
    def payload(self) -> dict[str, Any]:
        ...
        return cast(
            "dict[str, Any]",
            json.loads(self._decode_segment(self.split(".")[1]).decode()),
        )
