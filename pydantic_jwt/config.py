...
class ConfigDict(PydanticConfigDict, total=False):
    ...
    ```
        ...
        Attributes:
            ...
            require_keys: Whether a missing key is an error. When `False`, tokens are
                accepted without signature verification and a warning is logged.
    """
